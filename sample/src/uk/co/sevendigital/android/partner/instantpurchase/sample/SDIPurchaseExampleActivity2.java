 ...
 * 
 */
public class SDIPurchaseExampleActivity2 extends SherlockFragmentActivity implements TrackDialogFragmentListener {
	...
	@Override public void onCreate(Bundle savedInstanceState) {
		...
		mBuyButton.setOnClickListener(new OnClickListener() {
			...
			@Override public void onClick(View v) {
				...
				SDIPurchaseFragmentActivity.startActivity(SDIPurchaseExampleActivity2.this, releaseId, trackId, null, "US");
			}
		});
